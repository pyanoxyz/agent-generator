...
def create_environment_template(enviroment_request: EnviromentRequest):
...
"""
    ...
    return f"""{prompt}
    character json:
    {enviroment_request.character_json}
    
    Requirements :
    use clients, modelProvider, and plugins keys from character json
